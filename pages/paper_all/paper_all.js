...
Page({
  ...
  touchEnd: function (e) {
    ...
    for (var index in this.data.answers.allList) {
      this.data.answers.allList[index].isAnswer=0
     }
    return false
  },
  //swiper切换
...
switch ( this.data.papertype ) {
  case "1001":
    for (var i = 0; i < questionData.data_all.length; i++) {
